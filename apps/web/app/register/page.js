...
export default function RegisterPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-[#090a0f] p-4 text-gray-100 overflow-hidden">
      <div className="pointer-events-none absolute -top-40 -right-40 h-96 w-96 rounded-full bg-blue-600/30 blur-[120px]" />
      <div className="pointer-events-none absolute -bottom-40 -left-40 h-96 w-96 rounded-full bg-pink-600/25 blur-[120px]" />
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-white/10 bg-[#12141d]/80 p-8 shadow-2xl shadow-black/80 backdrop-blur-2xl">
        <div className="mb-6 text-center">
          ...
          <p className="mt-1 text-sm text-gray-400">Join Cric IPTV for high-quality live sports</p>
        </div>
